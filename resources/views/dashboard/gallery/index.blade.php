<x-dashboard.layout title="Manajemen Gallery">
    ...
    <div class="max-w-7xl mx-auto space-y-6 mt-5">
        
        <!-- Header -->
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
            <div class="relative bg-gradient-to-br from-purple-500 to-indigo-600 px-8 py-10">
                <!-- Decorative circles -->
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="bg-gradient-to-r from-purple-50 to-indigo-50 px-6 py-4 border-b border-pink-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
                                <i class="fas fa-heading text-purple-700"></i>
                                Judul Foto
                        ...
                        <div>
                            <label class="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
                                <i class="fas fa-image text-purple-700"></i>
                                Upload Gambar
                            ...
                            <input type="file" 
                                   ...
                                   class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm cursor-pointer focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all
                                          ...
                                          file:bg-gradient-to-r file:from-purple-500 file:to-indigo-600
                                          file:text-white file:text-sm
                                          file:font-semibold file:cursor-pointer
                                          hover:file:from-purple-600 hover:file:to-indigo-700">
                        </div>
                    </div>

                    <div class="flex justify-end pt-2">
                        <button type="submit"
                                class="px-6 py-3 bg-gradient-to-br from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 text-white font-semibold rounded-xl transition-all shadow-lg shadow-pink-500/30 hover:scale-105 flex items-center gap-2">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="flex gap-2">
                                        <a href="{{ route('gallery.edit', $item->id) }}"
                                           class="flex-1 py-2 bg-gradient-to-br from-blue-500 to-indigo-700 hover:from-blue-600 hover:to-indigo-800 text-white text-center rounded-xl font-semibold text-sm transition-all shadow-sm hover:shadow-md flex items-center justify-center gap-1.5">
                                        ...
                                        <button 
                                            ...
                                            class="flex-1 py-2 bg-gradient-to-br from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 text-white rounded-xl font-semibold text-sm transition-all shadow-sm hover:shadow-md flex items-center justify-center gap-1.5">
