    ...
    <div class="relative flex flex-col items-center mt-24 mb-20">
        <div class="w-[85%] max-w-7xl">
            ...
            <div class="text-center mb-12">
                <h1 class="text-5xl font-bold text-purple-950 mb-4">Semua Pengumuman</h1>
                <p class="text-lg text-gray-600">Informasi dan pengumuman penting dari organisasi kami</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                @empty
                    <div class="col-span-full text-center py-20">
                        ...
                        <p class="text-gray-500 text-lg">Pengumuman terbaru akan muncul di sini</p>
                    </div>
                @endforelse
            </div>
        </div>
